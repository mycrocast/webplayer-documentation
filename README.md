...
```
<script id="mycrocast_base" src="https://mycrocast-webplayer.s3.eu-central-1.amazonaws.com/versioning-main.js" player=”LITE_PLAYER”>
</script>
```
...
```
<mycrocast-lite-player token="1567504890375_8741a554-c25e-428f-a807-a69bac373315-9999">
...
mcc-lite-player::part(mcc-listener-info) {
    ...
    /*optional: can be hidden using this*/
    display: none;
}
```
